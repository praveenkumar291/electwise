    ...
    <Layout>
      <div>
        ...
        <div className=" grid grid-cols-1  sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8 pl-10 pr-10 pb-10 ">
          ...
          <div className="">
            <div className=" bg-orange-400 p-2   w-full max-w-5xl w- auto sm:w-full sm:p-4 h-auto sm:h-48  shadow-lg flex flex-col sm:flex-row select-none">
              <div className="sm:h-full sm:w-36 rounded-xl bg-gray-100 bg-center bg-cover">
                <img src="https://www.electwise.in/media/images/parties/logo/bharatiya-janata-party.jpg" />
              </div>
            ...
            <div className="bg-white p-2 w-full max-w-6xl sm:w-full sm:p-4 mt-2.5 h-auto w-auto shadow-lg flex flex-col sm:flex-row  select-none">
              <div className="text-left   w-full">
                ...
                <p className="text-gray-500 flex leading-9   line-clamp-3 ">
                  Raj Nath Singh (2013-2014 )
                </p>
                <p className="text-gray-500 flex  leading-9 line-clamp-3 ">
                  Raj Nath Singh (2005-2009 )
                </p>
                <p className="text-gray-500 flex  leading-9 line-clamp-3 ">
                    ...
                    <div className="mb-8 w-auto">
                      <Link href="narendramodi">
                        <img
                          ...
                          src="https://www.electwise.in/media/images/people/photo/atal-bihari-vajpayee.jpg"
                          alt=""
                          width="320"
                          height="222"
                        />
                  ...
                  <div className="w-full rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                    <div className="mb-8">
                      <Link href="rahul">
                        <img
                          className="object-center object-cover rounded-full h-32 w-32"
                          src="https://www.electwise.in/media/images/people/photo/manoj-tiwari.jpg"
                          alt=""
                          width="320"
                          height="222"
                        />
                  ...
                  <div className="w-full  rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                    <div className="mb-8">
                      <Link href="ombirla">
                        <img
                          className="object-center object-cover rounded-full h-32 w-32 "
                          src="https://www.electwise.in/media/images/people/photo/nadda.png"
                          alt=""
                          width="220"
                          height="220"
                        />
              ...
              <div className="text-left  w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-1">
                  <div class="w-full rounded-none sahdow-lg overflow-hidden flex flex-row justify-center items-center flex">
                    <img
                      src="https://www.electwise.in/media/images/parties/election-symbols/Bharatiya_Janata_Party_.jpg"
                      alt=""
                      width="220"
                      height="220"
                    />
