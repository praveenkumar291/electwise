  ...
  return (
    <div>
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8 pl-10 pr-10">
        ...
        <div className="">
          <div className="bg-white p-2    max-w-5xl w- auto sm:w-full sm:p-4 h-auto sm:h-48  shadow-lg flex flex-col sm:flex-row select-none">
            <div className="sm:h-full sm:w-36 rounded-xl bg-gray-100 bg-center bg-cover">
              <img src="https://www.electwise.in/media/images/people/photo/Ramvir_Singh_Bidhuri.jpg" />
            </div>
            <div className="flex sm:flex-1 flex-col gap-2 p-1">
              ...
              <p className="text-gray-500 flex  sm:text-base line-clamp-3 ">
                <Link href=" https://www.facebook.com/theramvirsinghbidhuri">
                  <i className="p-2">
                    <ImFacebook />
                  </i>
                </Link>
                ...
                <Link href="https://en.wikipedia.org/wiki/Ramvir_Singh_Bidhuri">
                  <i className="p-2">
                    <FaWikipediaW />
                  </i>
                </Link>
          ...
          <div className="bg-white p-2 w-full max-w-6xl sm:w-full h-20  mt-2.5  shadow-lg flex flex-col sm:flex-row  select-none">
            <div className="text-left   w-full">
              ...
              <p className="text-gray-500 flex  sm:text-base line-clamp-3 ">
                Dec 4, 1952 in Siwani, Hisar, Delhi
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-2 w-full max-w-6xl sm:w-full sm:p-4 mt-2.5  h-auto  shadow-lg flex flex-col sm:flex-row  select-none">
            <div className="text-left   w-full">
              ...
              <p className="text-gray-500 flex  sm:text-base line-clamp-3 ">
                Graduate Professional/B.Tech, Mechnical Engineering, University
                of delhi,1989
              </p>
            </div>
          </div>
          <div className="bg-white p-2 w-full max-w-6xl sm:w-full sm:p-4 mt-2.5 h-28  shadow-lg flex flex-col sm:flex-row  select-none">
            <div className="text-left   w-full">
              ...
              <p className="text-gray-500 flex  sm:text-base line-clamp-3 ">
                Opposition Leader of Delhi (Present)
              </p>
              <p className="text-gray-500 flex  sm:text-base line-clamp-3 ">
                OPPChief Minister of Delhi
              </p>
            </div>
          </div>
              ...
              <div className="inline-block w-auto flex overflow-hidden   pt-1 rounded-bl-lg rounded-br-lg">
                <table className="min-w-full  ">
                  ...
                  <tbody className="text-gray-700">
                    <tr>
                      <td className="w-1/12 text-left  px-1">Badarpur-2020</td>
                      <td className="w-1/4text-left  px-1">BJP</td>
                      <td className="w-1/12 text-left px-1">Won</td>
                      <td className="w-1/12 text-left  px-1">1</td>
                      <td className="w-1/12 text-left  px-1">90,082</td>
                      <td className="w-1/12 text-left px-1"></td>
                      <td className="w-1/12 text-left  px-1">3,719</td>
                    </tr>
                    <tr className="bg-gray-100">
                      <td className="w-1/12 text-left  px-1 ">Badarpur-2015</td>
                      <td className="w-1/12 text-left  px-1">BJP</td>
                      <td className="w-1/12 text-left  px-1 ">Lost</td>
                      <td className="w-1/12 text-left  px-1 "></td>
                      <td className="w-1/12 text-left  px-1 "></td>
                      <td className="w-1/12 text-left  px-1 "></td>
                    ...
                    <tr>
                      <td className="w-1/12 text-left  px-1">Badarpur-2013</td>
                      <td className="w-1/12 text-left  px-1"> BJP</td>
                      <td className="w-1/12  text-left  px-1">Won</td>
                      <td className=" w-1/12 text-left  px-1"></td>
                      <td className=" w-1/12 text-left px-1">13,854</td>
                    </tr>
                    <tr className="bg-gray-100">
                      <td className="w-1/12 text-left px-1">Badarpur-2008</td>
                      <td className="w-1/12 text-left  px-1">INC</td>
                      <td className="w-1/12 text-left  px-1">Lost</td>
                      <td className="w-1/12 text-left  px-1"></td>
                      <td className="w-1/12 text-left  px-1"></td>
